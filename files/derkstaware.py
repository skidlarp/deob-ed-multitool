# only note from bandwidth guy who deobed this im not fixing errors thats on yall!
...
class Main:
    def __init__(self):
        ...
        self.discord = "https://discord.gg/derkstaware"
        self.option = 0
    ...
    def send(self):
        ...
        try:
            ...
            print(f"\n{Fore.GREEN}[BOT IS RUNNING NOW]{Fore.RESET}")
...
▀█████████▄ ███    ███ ▄███▀   ███    ███ ███    ███ ▀█████████▄ 
   ▀███▀▀██ ███▌   ███▐██▀     ███    ███ ███    ███    ▀███▀▀██ 
    ...
    ███     ███    ███ ▀███▄   ███    ███ ███    ███     ███     
   ▄████▀   █▀     ███   ▀█▀ ▄█████████▀   ▀██████▀     ▄████▀   
@Derk - t.me/derkstaware - discord.gg/derkstaware
        """ + Fore.RESET)
